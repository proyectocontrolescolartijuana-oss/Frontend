...
import FormatoTituloSuficienciaFilters from "../components/formatoTituloSuficiencia/FormatoTituloSuficienciaFilters";
import FormatoTituloSuficienciaHeader from "../components/formatoTituloSuficiencia/FormatoTituloSuficienciaHeader";
import FormatoTituloSuficienciaPreview from "../components/formatoTituloSuficiencia/FormatoTituloSuficienciaPreview";
import FormatoTituloSuficienciaStyles from "../components/formatoTituloSuficiencia/FormatoTituloSuficienciaStyles";
import {
  CAMPOS_VACIOS,
  datosEstaticos,
  extraerNombre,
  ...
  obtenerMaterias,
  textoAlumno,
} from "../components/formatoTituloSuficiencia/formatoTituloSuficienciaUtils";
...
export default function FormatoTituloSuficiencia() {
  ...
  const handleDownload = () => {
    ...
    document.title = "formato_titulo_suficiencia";
  ...
  return (
    <div className="space-y-6 p-6">
      <FormatoTituloSuficienciaStyles />

      <FormatoTituloSuficienciaHeader onDownload={handleDownload} />

      <div className="h-px w-full bg-slate-200" />

      <FormatoTituloSuficienciaFilters
      ...
      <FormatoTituloSuficienciaPreview
        data={data}
