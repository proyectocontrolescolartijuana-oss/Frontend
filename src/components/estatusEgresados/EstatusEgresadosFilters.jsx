export default function EstatusEgresadosFilters({
  busqueda,
  carreras,
  carreraId,
  error,
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1fr_1fr_auto]">
        <label className="block">
          ...
          <select
            ...
            className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:border-blue-500 disabled:bg-slate-50"
          >
            <option value="">
        ...
        <label className="block">
          ...
          >
            <option value="">
              {carreraId ? "Selecciona grupo" : "Selecciona carrera primero"}
            </option>
